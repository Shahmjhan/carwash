        ...
        <table class="report-table">
            <thead>
                <tr>
                    ...
                    <th>Phone</th>
                    <th>Email</th>
                    <th class="text-right">Jobs in Period</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ $customer->jobs->count() }}</td>
                    <td class="text-right">Rs. {{ number_format($customer->jobs->sum('total'), 2) }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="empty">No customers found for this period.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="report-card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <span>{{ $customer->jobs->count() }}</span>
                </div>
                <div class="row highlight">
                    <span class="label">Total Spent</span>
                    <span class="text-green">Rs. {{ number_format($customer->jobs->sum('total'), 2) }}</span>
                </div>
            </div>
        </div>
        @empty
        <div class="empty-state">No customers found for this period.</div>
        @endforelse
    </div>
...
{{ $customer->name }} | Jobs: {{ $customer->jobs->count() }} | Rs.{{ number_format($customer->jobs->sum('total'), 2) }}
@endforeach
================================
