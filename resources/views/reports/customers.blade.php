...
<div id="report-content" class="panel">
    ...
    <div style="text-align:center;margin-bottom:30px;">
        <h1 style="margin:0 0 10px 0;">Customer Report</h1>
    ...
    <table style="width:100%;border-collapse:collapse;">
        <thead>
            <tr style="background:#f3f4f6;">
                ...
                <th style="padding:12px;text-align:right;border-bottom:2px solid #e5e7eb;">Jobs in Period</th>
                <th style="padding:12px;text-align:right;border-bottom:2px solid #e5e7eb;">Total Spent</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr style="border-bottom:1px solid #e5e7eb;">
                ...
                <td style="padding:12px;text-align:right;">{{ $customer->jobs->count() }}</td>
                <td style="padding:12px;text-align:right;">Rs. {{ number_format($customer->jobs->sum('total'), 2) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
